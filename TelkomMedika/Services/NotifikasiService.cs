...
namespace Tubes_KPL_Kelompok_1.Services
{
    ...
    {
        private static readonly NotifikasiService _instance = new();
        public static NotifikasiService Instance => _instance;
        ...
        public Response<List<Notifikasi>> GetSemuaNotifikasi()
        {
            return new Response<List<Notifikasi>> { Status = true, Data = _notifikasiList, Message = $"Ditemukan {_notifikasiList.Count} notifikasi." };
        }
